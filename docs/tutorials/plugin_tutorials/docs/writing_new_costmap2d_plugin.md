...
| isClearable()        | Method is called to ask the plugin: should it be processed during clearing operations or not.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Yes                      |
...
Run Turtlebot3 simulation with enabled Nav2. Detailed instructions how to make it are written at [Quickstart][quickstart]. Below is shortcut command for that:
